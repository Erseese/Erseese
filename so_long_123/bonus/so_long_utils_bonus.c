...
/*   Updated: 2024/01/25 13:35:57 by ytouihar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	destroy_bonus(t_mlx *game)
{
	if (game->persol.chara)
		mlx_destroy_image(game->mlx_init, game->persol.chara);
	if (game->persor.chara)
		mlx_destroy_image(game->mlx_init, game->persor.chara);
	if (game->persod.chara)
		mlx_destroy_image(game->mlx_init, game->persod.chara);
	if (game->enemy.chara)
		mlx_destroy_image(game->mlx_init, game->enemy.chara);
	if (game->persou.chara)
		mlx_destroy_image(game->mlx_init, game->persou.chara);
}

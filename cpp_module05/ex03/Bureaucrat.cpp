...
/*   Updated: 2023/12/18 10:28:48 by ytouihar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::signForm(FormA &form)
{    
	try
	{
		form.beSigned(*this);
	...
	{
		std::cout << this->_name << " couldn’t sign : " << form.getName() << " because their grade 👎." << std::endl;
	}
}

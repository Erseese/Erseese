...
/*   Updated: 2023/12/18 12:51:36 by ytouihar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "Grade exec : " << _grade_exec;
	return (_grade_exec);
}
int		FormA::getSignGrade(void) const
{
	std::cout << "Grade sign : " << _grade_sign;
	return (_grade_sign);
}

bool		FormA::getbool(void) const
{
	std::cout << "bool : " << _signed;
	return (_signed);
}
...
{
    out << FormA.getName() << " grade to sign : " << FormA.getSignGrade() << " grade to exec : " << FormA.getExecGrade() << " signed : " << FormA.getbool() << std::endl;
    return (out);
}
